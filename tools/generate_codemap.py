...
LAYER_NOTES = {
    ...
    "cloud_instance/util/fetch.py": "Provider fetch logic. Queries cloud APIs for existing instances.",
    "cloud_instance/util/parse.py": "Provider response parsers. Converts cloud API responses into the common instance dict shape.",
    "cloud_instance/util/provision.py": "Provider provisioning logic. Creates instances and provider-specific resources.",
    "cloud_instance/util/terminate.py": "Provider termination logic. Deletes instances and cleans up reserved IP resources.",
